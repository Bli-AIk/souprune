...
pub fn load_ui_solid_fill_body() -> String {
    std::fs::read_to_string("projects/example_mod/shaders/ui_solid_fill.wgsl").unwrap_or_else(|e| {
        eprintln!(
            "Warning: Failed to load shader from projects/example_mod/shaders/ui_solid_fill.wgsl: {}",
            e
        );
