//! Project-format data path resolvers and condition resolvers.
//!
//! 项目格式数据路径解析器和条件解析器。
//!
//! These register computed data paths (e.g. "player.total_attack")
//! and view conditions (e.g. "player.hp.is_low") that depend on
//! schema-backed facts such as equipment, inventory, and stats.
...
/// Register computed data path resolvers for schema-backed player data.
...
/// Register condition resolvers for schema-backed player data.
