...
//! ## 模块概述
//!
//! Registers the top_down-specific custom FRE actions and applies their deferred side
...
use crate::core::top_down::tilemap::object_properties::ObjectCollider;
...
/// System to setup top_down-specific action handlers in ActionHandlerRegistry.
