...
use crate::core::top_down::{TopDownUpdate, character};
#[derive(Clone)]
...
fn spawn_player_on_event(
    ...
    let Some(scope) = crate::core::top_down::top_down_scoped(&sequence_mode) else {
        warn!("TopDown player: no active mode while spawning player.");
        return;
    };
...
pub fn spawn_top_down_player(
    ...
    asset_server: &Res<AssetServer>,
    player_behavior: &Res<PlayerBehavior>,
    mode_scoped: crate::core::mode::ModeScoped,
) {
    use crate::core::character_asset::{AnimationConfigAsset, CharacterAnimator};
    use crate::core::collision::Rect2DCollider;
    use crate::core::input::Action;
    use crate::core::top_down::character::components::*;
    ...
    commands.spawn((
        ...
        PlayerControlled,
        BulletTarget::new(),
        crate::core::top_down::chase::ChaseHighlight,
