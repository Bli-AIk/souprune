...
//! ## 模块概述
//!
//! Prepares the data and proxy entities required by the top_down tile-reveal effect.
...
pub(super) fn create_tile_sprites_system(
    ...
    player_behavior: Option<Res<crate::core::top_down::player::config::PlayerBehavior>>,
