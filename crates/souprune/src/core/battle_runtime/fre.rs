...
use crate::core::battle_runtime::menu_state::{
    BattleMenuStateTracker, sync_battle_menu_state_system,
};
...
pub use crate::core::battle_runtime::speech_bubble::{
...
fn setup_battle_fre_system(
    ...
    commands.spawn((
        ...
        BattleInputEntity,
        crate::core::battle_runtime::battle_scoped(),
