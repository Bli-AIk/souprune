...
use crate::core::overworld::character;
...
pub fn generate_collision_tiles_system(
    ...
    existing_object_colliders: Query<&crate::core::overworld::tilemap::ObjectCollider>,
        ...
        for object_data in object_layer.objects() {
            ...
            if has_collision {
                ...
                commands.spawn((
                    ...
                    crate::core::overworld::tilemap::ObjectCollider,
                    TilemapCollider,
