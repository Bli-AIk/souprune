//! Renders the FRE debug panel tab that exposes app, sequence, and chase state information.
//!
...
fn render_chase_state_section(ui: &mut egui::Ui, world: &mut World) {
    ...
    let chase_enabled_display: Option<(&str, egui::Color32)> = world
        .get_resource::<crate::core::overworld::chase::ChaseEnabled>()
        .map(|c| {
            if c.0 {
    ...
    let chase_name_val = world
        .get_resource::<crate::core::overworld::chase::ChaseStateName>()
