...
As a project bridging the **UTDR fangame community** and the **Rust/Bevy ecosystem**, we particularly value
cross-community respect — different backgrounds bring different strengths, and all forms of contribution are equally
important.
...
7. Being mindful of **language barriers** — our community uses both English and Chinese, and misunderstandings may arise
   from translation rather than intent.
8. Respecting **original creators' rights** — as a fangame framework community, we must remain aware of and respect the
   intellectual property of the original works that inspire us.
...
2. **Temporarily Limited Activities**
    ...
    - Consequence: A private, written warning with a time-limited cooldown period designed to underscore the seriousness
      of the situation and give the community members involved time to process the incident.
